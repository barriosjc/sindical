...
<div class="container" style="padding-top: 80px">
    ...
    <br />
    <form id="f_procesar" method="POST" enctype="multipart/form-data" action="{{route('secretariado.informes')}}">
        @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="informe" id="informe" class="form-control form-control-sm" style="width: 100%" required>
                        ...
                        @foreach($informes as $dato)
                            <option value="1" >diferencia con padrón del secretariado</option>
                        @endforeach
                    </select>
                </div>
            </div>
