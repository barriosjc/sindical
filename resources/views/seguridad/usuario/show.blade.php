      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="{{ url('/usuario/' . $user->id . '/edit') }}" title="Edit Usuario"><button class="btn btn-primary btn-sm"><i class="far fa-edit"></i></button></a>
            ...
            <div class="table-responsive">
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    <th> Avatar </th>
                    <td> <img src="{{Storage::url($user->foto)}}" class="rounded-circle" width="45px" alt=""> </td>
                  </tr>
                  <tr>
